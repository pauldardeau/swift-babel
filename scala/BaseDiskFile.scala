...
abstract class BaseDiskFile {
    ...
    */
    def BaseDiskFile(mgr: DiskFileManager,
                             device_path: String,
    ...
    @classmethod
    def static from_hash_dir(Class cls,
                              DiskFileManager mgr,
    ...
    */
    def open() {
        ...
        try {
            files = os.listdir(this._datadir);
        } catch (OSError err) {
...
// gather info about the valid files to use to open the DiskFile
    ...
    */
    def _quarantine(data_file: String, msg: String) : Exception = {
    ...
    @return dict of files to use having keys 'data_file', 'ts_file',
             'meta_file'
    */
    def abstract _get_ondisk_files(List[String] files);
    ...
    @return DiskFileDeleted if the ts_file was provided, else
              DiskFileNotExist
    */
    def _construct_exception_from_ts_file(ts_file: String) : Exception = {
    ...
    def _verify_name_matches_hash(data_file: String) {
    ...
    @throws DiskFileQuarantined if data inconsistencies were detected
                                 ...
                                 metadata
    */
    def _verify_data_file(String data_file, Object fp) {
    ...
    def _failsafe_read_metadata(String source,
    ...
    */
    def _construct_from_data_file(String data_file,
                                          String meta_file) {
    ...
    */
    def reader(keep_cache: Boolean, //=false,
               QuarantineHook quarantine_hook) : DiskFileReader = { //=lambda m: null) {
    ...
    */
    def write_metadata(HashMap metadata) {
