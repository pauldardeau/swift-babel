...
public:
    ...
    void app_iter_range(int start, int stop) {
    ...
    void app_iter_ranges(ranges, content_type, boundary, size) {
        ...
        if (!ranges) {
            ...
            try {
                ...
                for (chunk; multi_range_iterator(
    ...
    void _drop_cache(int fd, int offset, int length) {
