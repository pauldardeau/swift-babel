...
protected:
    void _reload(bool force=false) {
        ...
        if (force || this.has_changed()) {
            ring_data = RingData.load(this.serialized_path);
...
public:
    ...
    */
    int replica_count() {
        return this._replica2part2dev_id.length;
    }
    ...
    */
    int partition_count() {
        return this._replica2part2dev_id[0].length;
    }
